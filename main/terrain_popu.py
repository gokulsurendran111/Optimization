...
UserLoc=np.loadtxt("population1.txt",dtype='float')
# UserLoc=np.array([[495,435,5],[450,480,5],[999,999,999]])

terrain = terrain_z
DroneLoc=np.array([[900,900,terrain[900,900]+100],[300,300,terrain[300,300]+100],[500,500,terrain[500,500]+100],
                [300,700,terrain[300,700]+100],[100,900,terrain[100,900]+100],[700,300,terrain[700,300]+100],
                ])

Ndrones=6
Rmax=200
for i in range(Ndrones-1):
